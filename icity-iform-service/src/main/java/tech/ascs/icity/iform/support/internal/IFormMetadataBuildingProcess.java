...
public class IFormMetadataBuildingProcess {
	private static final Logger log = Logger.getLogger( IFormMetadataBuildingProcess.class );
	...
	public static MetadataImplementor complete(final ManagedResources managedResources, final MetadataBuildingOptions options) {
		...
		final InFlightMetadataCollectorImpl metadataCollector = new IFormInFlightMetadataCollectorImpl(
				options,
